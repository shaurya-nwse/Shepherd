...
from kafka_kinesis.serdes.deserializers import Deserializer
...
class KafkaConsumer:
    ...
    def create_consumer(self) -> AIOKafkaConsumer:
        ...
        return AIOKafkaConsumer(
            ...
            value_deserializer=(
                self.value_deserializer.deserialize if self.value_deserializer else lambda x: x
            ),
            key_deserializer=(
                self.key_deserializer.deserialize if self.key_deserializer else lambda x: x
            ),
